...
exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.some(r => ["R", "ROL ID"].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
...
.setFooter(`VALOROUS ❤️ TITAN`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
