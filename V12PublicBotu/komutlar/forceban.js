           ...
           .then(bans => {
               ...
               message.guild.members.ban(seyfooo, sebeb)
                   .then(async (member) => {
                       ...
                       message.channel.send(`<@!${user.id}> adlı kullanıcı banlandı <a:titanok:775416011499241533>  `);
                   })
                   .catch(error => {
           ...
           .then(bans => {
               ...
               message.guild.ban(seyfooo, sebeb)
                   .then(async (member) => {
                       ...
                       message.channel.send(`<@!${user.id}> sunucudan yasaklandı <a:titanok:775416011499241533>`);
                   })
                   .catch(error => {
