...
let tag = "⍱"
const kayıtlı = message.guild.roles.cache.find(r => r.id === '773291239759675432')
const kayıtlı2 = message.guild.roles.cache.find(r => r.id === '773291240321056809')
...
.setColor('GREEN')
client.channels.cache.get('773291347859603506').send(embed)
