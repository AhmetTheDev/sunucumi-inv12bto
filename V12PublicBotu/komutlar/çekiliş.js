...
var filter = m => m.author.id === message.author.id;
      ...
      message.channel.awaitMessages(filter, {
        ...
        if(!room) return message.channel.send('<a:emoji_30:773887166245371946>| **Böyle bir kanal bulamadım**');
        ...
        msg.edit(':eight_pointed_black_star:| **Çekilişin süresini belirle (1s, 1m, 1h, 1d, 1w)**').then(msg => {
          message.channel.awaitMessages(filter, {
            ...
            if(!collected.first().content.match(/[1-60][s,m,h,d,w]/g)) return message.channel.send('<a:emoji_30:773887166245371946>| **Böyle bir süre bilmiyorum :(**');
            ...
            msg.edit(':eight_pointed_black_star:| **Şimdi de ödülü yaz bakalım**').then(msg => {
              message.channel.awaitMessages(filter, {
                ...
                try {
                  ...
                  .setFooter(message.author.username + " TITAN Bot Çekiliş Sistemi", message.author.avatarURL);
                  message.guild.channels.cache.find(x => x.name ===  room).send(' <a:titan_17:773903629236961340> **ÇEKİLİŞ BAŞLADI** <a:titan_17:773903629236961340>' , {embed: giveEmbed}).then(m => {
                     let re = m.react('🎉');
                     setTimeout(() => {
                       ...
                       .setTitle(title)
                       .setColor("#f558c9")
            .setFooter("TITAN Bot çekiliş sistemi")
                     ...
                     m.edit('** 🎉 ÇEKİLİŞ BİTTİ 🎉**' , {embed: endEmbed});
                       ...
                       var embedLel = new Discord.MessageEmbed()
                        .setColor("RANDOM")
                        .setDescription("Ödülünü Moderatörleri Etiketleyerek Alabilirsin!").setFooter("TITAN bot çekiliş sistemi")
